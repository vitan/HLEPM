...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Risk.due_date'
        db.delete_column('track_risk', 'due_date')

        # Adding field 'Risk.target_date'
        db.add_column('track_risk', 'target_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Risk.due_date'
        db.add_column('track_risk', 'due_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 5, 0, 0)),
                      keep_default=False)

        # Deleting field 'Risk.target_date'
        db.delete_column('track_risk', 'target_date')
