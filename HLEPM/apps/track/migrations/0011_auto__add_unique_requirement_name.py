...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Requirement', fields ['name']
        db.create_unique('track_requirement', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Requirement', fields ['name']
        db.delete_unique('track_requirement', ['name'])
