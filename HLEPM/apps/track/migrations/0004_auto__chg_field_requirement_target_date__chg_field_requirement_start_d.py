...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Requirement.target_date'
        db.alter_column('track_requirement', 'target_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Requirement.start_date'
        db.alter_column('track_requirement', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Requirement.target_date'
        db.alter_column('track_requirement', 'target_date', self.gf('django.db.models.fields.DateTimeField')(default=0))

        # Changing field 'Requirement.start_date'
        db.alter_column('track_requirement', 'start_date', self.gf('django.db.models.fields.DateTimeField')(default=0))
