...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.target_date'
        db.alter_column('track_issue', 'target_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Issue.start_date'
        db.alter_column('track_issue', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Issue.target_date'
        db.alter_column('track_issue', 'target_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 25, 0, 0)))

        # Changing field 'Issue.start_date'
        db.alter_column('track_issue', 'start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 25, 0, 0)))
    ...
    models = {
        ...
        'track.issue': {
            ...
            'target_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
        'track.issuestatus': {
