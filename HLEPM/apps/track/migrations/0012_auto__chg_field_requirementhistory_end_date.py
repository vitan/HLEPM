...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RequirementHistory.end_date'
        db.alter_column('track_requirementhistory', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):

        # Changing field 'RequirementHistory.end_date'
        db.alter_column('track_requirementhistory', 'end_date', self.gf('django.db.models.fields.DateTimeField')(default=1))
