...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Issue.dur_date'
        db.delete_column('track_issue', 'dur_date')

        # Adding field 'Issue.target_date'
        db.add_column('track_issue', 'target_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Issue.dur_date'
        db.add_column('track_issue', 'dur_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 18, 0, 0)),
                      keep_default=False)

        # Deleting field 'Issue.target_date'
        db.delete_column('track_issue', 'target_date')
