...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mitigation'
        db.create_table('track_mitigation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('track', ['Mitigation'])


    def backwards(self, orm):
        # Deleting model 'Mitigation'
        db.delete_table('track_mitigation')
