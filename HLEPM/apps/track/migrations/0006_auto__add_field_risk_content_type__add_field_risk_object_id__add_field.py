...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Risk.content_type'
        db.add_column('track_risk', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Risk.object_id'
        db.add_column('track_risk', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Issue.content_type'
        db.add_column('track_issue', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Issue.object_id'
        db.add_column('track_issue', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Risk.content_type'
        db.delete_column('track_risk', 'content_type_id')

        # Deleting field 'Risk.object_id'
        db.delete_column('track_risk', 'object_id')

        # Deleting field 'Issue.content_type'
        db.delete_column('track_issue', 'content_type_id')

        # Deleting field 'Issue.object_id'
        db.delete_column('track_issue', 'object_id')
