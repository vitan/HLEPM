...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Risk.target_date'
        db.alter_column('track_risk', 'target_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Risk.start_date'
        db.alter_column('track_risk', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Risk.target_date'
        db.alter_column('track_risk', 'target_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 25, 0, 0)))

        # Changing field 'Risk.start_date'
        db.alter_column('track_risk', 'start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 25, 0, 0)))
