...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RequirementHistory.end_date'
        db.delete_column('track_requirementhistory', 'end_date')

        # Deleting field 'RequirementHistory.start_date'
        db.delete_column('track_requirementhistory', 'start_date')

        # Deleting field 'RequirementHistory.owner'
        db.delete_column('track_requirementhistory', 'owner_id')

        # Adding field 'RequirementHistory.before_owner'
        db.add_column('track_requirementhistory', 'before_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='before_owner', to=orm['track.RequirementOwner']),
                      keep_default=False)

        # Adding field 'RequirementHistory.after_owner'
        db.add_column('track_requirementhistory', 'after_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='after_owner', to=orm['track.RequirementOwner']),
                      keep_default=False)

        # Adding field 'RequirementHistory.add_date'
        db.add_column('track_requirementhistory', 'add_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RequirementHistory.end_date'
        db.add_column('track_requirementhistory', 'end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RequirementHistory.start_date'
        db.add_column('track_requirementhistory', 'start_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'RequirementHistory.owner'
        db.add_column('track_requirementhistory', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['track.RequirementOwner']),
                      keep_default=False)

        # Deleting field 'RequirementHistory.before_owner'
        db.delete_column('track_requirementhistory', 'before_owner_id')

        # Deleting field 'RequirementHistory.after_owner'
        db.delete_column('track_requirementhistory', 'after_owner_id')

        # Deleting field 'RequirementHistory.add_date'
        db.delete_column('track_requirementhistory', 'add_date')
    ...
    models = {
        ...
        'track.requirementhistory': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'after_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'after_owner'", 'to': "orm['track.RequirementOwner']"}),
            'before_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'before_owner'", 'to': "orm['track.RequirementOwner']"}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'requirement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['track.Requirement']"})
        },
        'track.requirementowner': {
            'Meta': {'object_name': 'RequirementOwner'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '150'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['track.RequirementType']"})
        ...
        'track.requirementstatus': {
            'Meta': {'object_name': 'RequirementStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '150'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['track.RequirementType']"})
        ...
        'track.requirementtype': {
            'Meta': {'object_name': 'RequirementType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '150'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        ...
        'track.stakeholdertype': {
            'Meta': {'object_name': 'StakeholderType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '150'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
