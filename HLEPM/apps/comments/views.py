...
@require_POST
@login_required
def comment_add(request, next=None, using=None,
                template_name="comments/comment-ul.html"):
    """
    Post a comment.

    HTTP POST is required. If ``POST['submit'] == "preview"`` or if there are
    errors a preview template, ``comments/preview.html``, will be rendered.
    (weizhou) Here I reviewed django-comment source code for ajax transfer."
    """
