...
INSERT INTO `auth_user` VALUES (1,'admin','','','weizhou@redhat.com','pbkdf2_sha256$10000$6l0SiWkb6JVu$pW6WNaW9UMNmXvXk0Lf4vQQJwxbz5g51VCLvJI9zf3c=',1,1,1,'2013-01-30 08:48:48','2013-01-30 08:45:48');
...
INSERT INTO `django_content_type` VALUES (1,'permission','auth','permission'),(2,'group','auth','group'),(3,'user','auth','user'),(4,'content type','contenttypes','contenttype'),(5,'session','sessions','session'),(6,'site','sites','site'),(7,'log entry','admin','logentry'),(8,'comment','comments','comment'),(9,'comment flag','comments','commentflag'),(10,'product','track','product'),(11,'requirement content','track','requirementcontent'),(12,'requirement status','track','requirementstatus'),(13,'requirement owner','track','requirementowner'),(14,'version','track','version'),(15,'requirement','track','requirement'),(16,'phase','track','phase'),(17,'project type','track','projecttype'),(18,'project status','track','projectstatus'),(19,'project owner','track','projectowner'),(20,'project','track','project'),(21,'member type','track','membertype'),(22,'member','track','member'),(23,'stakeholder type','track','stakeholdertype'),(24,'department','track','department'),(25,'section','track','section'),(26,'stakeholder','track','stakeholder'),(27,'impact','track','impact'),(28,'response','track','response'),(29,'priority','track','priority'),(30,'probability','track','probability'),(31,'risk status','track','riskstatus'),(32,'risk','track','risk'),(33,'issue status','track','issuestatus'),(34,'issue','track','issue'),(35,'requirement history','track','requirementhistory'),(36,'project history','track','projecthistory'),(37,'email purpose','remind','emailpurpose'),(38,'email templates','remind','emailtemplates'),(39,'migration history','south','migrationhistory');
...
INSERT INTO `django_session` VALUES ('b13cb6d407cb0f2daa7007d9339cd1dc','N2ZhNmM1OTgyYTY4ZTk5NTg0MTc2MDc0YWZhMWJjODk1ZTQ1MmY1NzqAAn1xAShVEl9hdXRoX3Vz\nZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHED\nVQ1fYXV0aF91c2VyX2lkcQSKAQF1Lg==\n','2013-02-13 08:48:48');
...
CREATE TABLE `track_requirementowner` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  KEY `track_requirementowner_cc8ff3c` (`content_id`),
  CONSTRAINT `content_id_refs_id_58776a55` FOREIGN KEY (`content_id`) REFERENCES `track_requirementcontent` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-01-30 16:49:51
